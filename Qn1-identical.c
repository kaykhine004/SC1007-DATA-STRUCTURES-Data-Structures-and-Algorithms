...
{
    // chk if 2 trees are empty or 1 of them
    if(tree1 == NULL && tree2== NULL)
        return 1; // indentical if both are empty too
    else if(tree1 == NULL || tree2== NULL)
        return 0;

    if((tree1->item == tree2->item) && identical(tree1->left, tree2->left) && identical(tree1->right, tree2->right) )// all same ??
        return 1; //indentical
